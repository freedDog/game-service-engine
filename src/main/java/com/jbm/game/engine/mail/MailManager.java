...
public class MailManager {
	...
	public void initMailConfig(String configPath) {
		...
		if(mailConfig==null) {
			logger.warn("{}/mailConfig.xml 未找到配置文件",configPath);
	...
	public void sendTextMail(String title,String content,String... recives) {
		try {
			...
			props.put("mail.smtp.host", getMailConfig().getMailSmtpHost());
			props.put("mail.smtp.auth", getMailConfig().getMailSmtpAuth());
